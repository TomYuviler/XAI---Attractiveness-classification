...
#load images from CelebA dataset
...
#find normalized orthogonal vector
...
#claculate TCAV score for the concept
num_attr_images = 0
num_good_samples = 0
for i, data in enumerate(celeba_dataloader_atrr, 0):
    inputs, labels = data
