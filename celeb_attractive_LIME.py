...
#load images from CelebA with the selected attribute
...
attribute = "Weatin_Hat"
labels.loc[labels[attribute] == -1, attribute] = 0
labels = labels[attribute].tolist()
...
#transorm the image for the classification model
image_size = 64
